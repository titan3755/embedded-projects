...
<html>
<head>
<title>OLED Text Updater</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<style>
  html { font-family: Helvetica, Arial, sans-serif; display: inline-block; text-align: center; }
...
<form action="/update" method="get">
  ...
  <div class="form-group">
    <input type="number" name="size" placeholder="Text Size">
  </div>
  <div class="form-group">
    <input type="submit" value="Update OLED">
  </div>
</form>
</body>
</html>
